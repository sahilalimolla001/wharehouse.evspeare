...
class Config:
    ...
    SUPPORT_QUERY_TOKEN = os.getenv("SUPPORT_QUERY_TOKEN", "")
    ...
    GOOGLE_SHEETS_SYNC_MODE = os.getenv("GOOGLE_SHEETS_SYNC_MODE", "full")
    ...
    RAZORPAY_TIMEOUT = env_int("RAZORPAY_TIMEOUT", 20)
