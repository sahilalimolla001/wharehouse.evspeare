...
def validate_production():
    ...
    shiprocket_partial = any([Config.SHIPROCKET_EMAIL, Config.SHIPROCKET_PASSWORD, Config.SHIPROCKET_TOKEN, Config.SHIPROCKET_PICKUP_LOCATION, Config.SHIPROCKET_WEBHOOK_TOKEN])
